...
export function normalizeSchedulerTheme(value) {
...
export function normalizeSchedulerView(value) {
...
export function schedulerScrollbarWidth(element) {
  if (!element) return 0;
  return Math.max(
    0,
...
export function createSchedulerFactory(fabui) {
  'use strict';
