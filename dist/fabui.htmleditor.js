/*! FabUI HtmlEditor browser global | Optional extension; load FabUI core first */
(function(global) {
'use strict';
...
function normalizeHtmlEditorLocale(value) {
...
function normalizeHtmlEditorTheme(value) {
...
function normalizeHtmlEditorToolbar(value) {
...
function htmlEditorVideoMarkup(value) {
...
function createHtmlEditorFactory(fabui) {
  var Control;
  var registerControl;
